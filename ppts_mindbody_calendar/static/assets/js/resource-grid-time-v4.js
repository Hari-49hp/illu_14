    ...
    var F = function (e) {
        ...
        return n(t, e), t.prototype._processOptions = function (e, r) {
            ...
            return '<th class="fc-resource-cell" data-resource-id="' + e.id + '"' + (n ? ' data-date="' + o.formatIso(n, {
                omitTime: !0
            }) + '"' : "") + (t > 1 ? ' colspan="' + t + '"' : "") + ">  <div class='btn-group'><button type='button' class='btn btn-primary resourceHeader-label'>" + e.title + "</button>" +
                "<button type='button' class='btn btn-primary dropdown-toggle dropdown-toggle-split' data-toggle='dropdown'></button>" +
                "<div class='dropdown-menu'><a class='dropdown-item'  id='resources_go_to_week_view' data-res='" + e.id + "' href='#' onclick='resources_go_to_week_view(" + e.id + ")'>Go to week view</a><a class='dropdown-item' href='/booking/url/redirect/availability_list_view'>Edit schedule</a><a class='dropdown-item display-none' href='/booking/url/redirect/add_availability_view'>Add unavailability</a><a class='dropdown-item' href='/booking/id/redirect/employee_form/" + e.id + "'>View profile</a></div></div></th>"
