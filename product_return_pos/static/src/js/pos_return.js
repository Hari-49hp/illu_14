       ...
       var pos_reference = this.props.ref
        rpc.query({
                ...
                for(var j=0;j < lines.length; j++){
                    ...
                    var sub_total = product_line.sub_total;
                    qty_list[j+1] = product_line.qty;
                    var line_id = product_line.line_id;
                    var discount = product_line.discount;
                    rows += "<tr><td style='display:none;'>" + id + "</td><td style='display:none;'>" + price_unit +" </td><td>" + name + "</td><td>" + qty + "</td><td>"+ price_unit + "</td><td>" + discount + "</td><td style='display:none;'>" + line_id + "</td><td>"+ sub_total +"</td></tr>";
                ...
                for (var i = 1; i < tr.length; i++) {
                  ...
                  input.setAttribute("value", qty_list[i]);
        ...
        if (count > 0){
            ...
            for (var r=0, n = myTable.rows.length; r < n; r++) {
                ...
                if (return_qty > 0){
                    ...
                    quantity: return_qty,
                    discount:row.cells[5].innerHTML,
                    merge: false,
                    extras: {return_ref: this.props.ref, label: '0'}, //row.cells[4].innerHTML
                    });
                }
                c = c+1
