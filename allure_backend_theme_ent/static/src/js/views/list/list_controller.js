odoo.define('allure_backend_theme_ent.ListController', function (require) {
    "use strict";
    ...
    var CustomizeList = Dialog.extend({
        ...
        _onChangeView: function (ev) {
            ...
            this.$('.o_density_image img').attr('src', '/allure_backend_theme_ent/static/src/img/' + this.default_density + '.png')
        },
    ...
    ListController.include({
        ...
        willStart: function () {
            ...
            const acl = this.getSession().user_has_group('allure_backend_theme_ent.group_display_density').then(hasGroup => {
