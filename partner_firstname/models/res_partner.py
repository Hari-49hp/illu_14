...
class ResPartner(models.Model):
    ...
    location_flag_s = fields.Boolean(string='Use for Location')
    ...
    def _check_lname_length(self):
        if self.is_company == False and len(str(self.lastname)) < 2:
            raise UserError(_('The lastname should contain less than 2 value/Letter'))
